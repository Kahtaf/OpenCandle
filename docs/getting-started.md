...
Yahoo Finance, CoinGecko, SEC EDGAR, DuckDuckGo search, and the alternative.me crypto Fear & Greed index do not require keys. Reddit sentiment uses `rdt-cli` plus your normal Reddit browser session.
