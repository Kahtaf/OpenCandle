...
- Hosted model-key probes now allow enough time for the first browser-only Turnstile authorization exchange instead of failing after the native five-second probe deadline.
