...
- Retail-investor prompts now handle brokerage selection, ETF tradeoffs/overlap, unknown-ticker earnings risk, crypto position sizing, and market-closed "today" move questions with more direct guidance instead of punting or over-routing to portfolio construction.
