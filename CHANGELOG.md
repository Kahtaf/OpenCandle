...
- Hosted checkpoint validation now names the safe session, transcript, coordination, or catalog invariant that failed, so intermittent offline-bootstrap persistence errors can be diagnosed without exposing session contents or credentials.
