...
Calm, exacting, and useful.

The product should feel like research software operated by someone who respects financial risk. It should be direct about uncertainty, careful with numbers, and more interested in clear evidence than in impressive theater. The tone is pragmatic and analyst-grade: concise labels, visible provenance, restrained emphasis, and no false confidence.

## Anti-references

OpenCandle should not look or behave like a glossy fintech landing page, a gamified trading app, a crypto dashboard, or a decorative AI chat demo. Avoid navy-and-gold finance cliches, purple AI gradients, stock-photo polish, animated hero metrics, ornamental glass cards, and hidden tool capabilities that require guessing the right prompt.

The GUI should also avoid terminal cosplay. It can be dense and technical, but it should not bury basic controls, provider status, or session state behind obscure command syntax.
