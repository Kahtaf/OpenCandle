...
export function buildOptionsScreenerWorkflowDefinition(resolution: SlotResolution<OptionsScreenerSlots>): WorkflowDefinition {
  ...
  const riskInstruction = isCoveredCallContext
    ? "Include covered-call sale risks: assignment/capped upside, share-price downside in the owned stock, IV/event risk, and exit liquidity. Do not describe max loss as the option premium paid."
...
- Do not describe max loss as the option premium paid; covered-call sale risk is assignment/capped upside, share-price downside in the owned stock, IV/event risk, and poor exit liquidity.
