...
- **Portfolio**: track_portfolio, analyze_risk, manage_watchlist, analyze_correlation, track_prediction, manage_alerts, daily_watchlist_report — position tracking, P&L, Sharpe ratio, VaR, watchlist tracking, durable manual alerts, daily watchlist reports, correlation matrix, and prediction tracking with accuracy scoring
