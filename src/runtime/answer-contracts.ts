...
export const ANSWER_CONTRACT_REGISTRY: Record<AnswerContractId, AnswerContractDefinition> = {
  ...
  current_event_explanation: {
    ...
    requiredFinalFields: ["freshness_disclosure", "data_gap_disclosure"],
  ...
  sentiment_snapshot: placeholderContract("sentiment_snapshot", "sentiment_snapshot", "framework", ["source_coverage", "data_gap_disclosure"]),
  filing_thesis_review: placeholderContract("filing_thesis_review", "filing_thesis_review", "framework", ["source_coverage", "data_gap_disclosure"]),
  retail_tradeoff_framework: placeholderContract("retail_tradeoff_framework", "retail_finance_tradeoff", "framework", ["comparison_tradeoffs", "data_gap_disclosure"]),
  concept_explainer: {
