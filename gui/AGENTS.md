...
- Any UI change also requires an `impeccable` pass for UX correctness before closing the task — install skills listed in `skills-lock.json` (agents load it via their skills mechanism).
