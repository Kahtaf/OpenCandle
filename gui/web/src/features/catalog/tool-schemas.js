...
const QUERY_TICKER_OR_TOPIC = (overrides = {}) => ({
  ...
  required: true,
  placeholder: "AAPL or AI infrastructure",
  ...overrides,
});
...
const TOOL_SCHEMAS = {
  ...
  get_crypto_history: [
    ...
    },
    {
      ...
      suffix: "days",
      helper: "1, 7, 14, 30, 90, 180, 365, or 'max'.",
    },
  ],
  ...
  calculate_dcf: [
    SYMBOL(),
    {
      ...
      helper: "Annual. Estimated from history if blank.",
    },
    {
      name: "discount_rate",
      kind: "percent",
  ...
  get_economic_data: [
    {
      ...
      helper: "Common: CPIAUCSL (CPI), DGS10 (10Y), UNRATE (unemployment), FEDFUNDS.",
      suggestions: [
  ...
  manage_portfolio: [
    ...
    },
    {
      ...
      helper: "Per share, in your portfolio currency.",
    },
  ],
  watchlist: [
    {
  ...
  get_option_chain: [
    SYMBOL(),
    {
      ...
      kind: "date",
      label: "Expiration",
      helper: "Defaults to nearest expiration.",
    },
    {
      name: "type",
      kind: "segmented",
  ...
  get_reddit_sentiment: [
    {
      ...
      kind: "text",
      label: "Subreddit",
      placeholder: "wallstreetbets, stocks, all",
      helper: "Leave blank to search defaults.",
    },
